...
case object Estate   extends BaseVictoryCard { def cost = 2.coins ; def value = 1.vps }
case object Dutchy   extends BaseVictoryCard { def cost = 5.coins ; def value = 3.vps }
case object Province extends BaseVictoryCard { def cost = 8.coins ; def value = 6.vps }
